...
https://repo.cloudsync.netapp.com/gfc/2k16_GFC_2_1_0_31IMAGE.zip[Windows Server 2016 .VHDX including NetApp GFC (Microsoft Hyper-v)^]
...
https://repo.cloudsync.netapp.com/gfc/2k19_GFC_2_1_0_31IMAGE.zip[Windows Server 2019 .VHDX including NetApp GFC (Microsoft Hyper-v)^]
...
+
https://repo.cloudsync.netapp.com/gfc/Global%20File%20Cache%202.1.0%20User%20Guide.pdf[NetApp Global File Cache User Guide (.PDF)^]
...
NOTE: When deploying Global File Cache on a Windows Server 2016, you should be using .NET Framework 4.8 and Windows Web View2 framework.
...
For more information, see the https://repo.cloudsync.netapp.com/gfc/Global%20File%20Cache%202.1.0%20User%20Guide.pdf[NetApp Global File Cache User Guide^].
...
This section helps you to understand the requirements when running antivirus software on a Windows Server instance running Global File Cache. Global File Cache has tested most commonly used antivirus products including Cylance, McAfee, Symantec, Sophos, Trend Micro, Kaspersky, Crowd Strike, Cisco AMP, Tannium, and Windows Defender for use in conjunction with Global File Cache. The antivirus software should be certified by NetApp and is supported only if configured with the proper exclusion list. See Appendix A in the https://repo.cloudsync.netapp.com/gfc/Global%20File%20Cache%202.1.0%20User%20Guide.pdf[NetApp Global File Cache User Guide^]
