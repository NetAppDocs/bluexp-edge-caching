...
See Chapter 14 in the https://repo.cloudsync.netapp.com/gfc/Global%20File%20Cache%202.3.0%20User%20Guide.pdf[NetApp Global File Cache User Guide^] for additional material.
